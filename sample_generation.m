function [X_sample,fs_sample,ref] = sample_generation(dirName,param) 
    ...
    files = dir('C:\Users\NR\Downloads\MATLAB_audio_fingerprint-master\MATLAB_audio_fingerprint-master\test_songs\*.mp3');                  
    files = {files.name}';
    ...
    Xtemp = mean(x,2) ;
    "C:\Users\NR\Downloads\MATLAB_audio_fingerprint-master\MATLAB_audio_fingerprint-master\test_songs\song1.mp3";
